...
## Todos
  ...
  - [x] Add a "legend" over the scoreboard to describe the color coding scheme

  - [x] Add the cancelled submissions to the encoded setup string generated by the Copy Contest tool
  ...
  - [ ] Show a confirmation alert on page-unloading attempts while a contest is running
