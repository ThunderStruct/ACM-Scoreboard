...
#### Copy Contest
  ...
  *note: the generated string does _NOT_ contain cancelled submissions' data. All cancelled submissions must be re-entered as of version 1.0.0*
...
## Todos
  ...
  - [ ] Add a "legend" over the scoreboard to describe the color coding scheme

  - [ ] Add the cancelled submissions to the encoded setup string generated by the Copy Contest tool
